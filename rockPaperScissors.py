...
def gui():
    ...
    Radiobutton(rps_frame, text = "Rock", variable = player_choice, value = 1).grid(column = 1, row = 2, sticky = "nsew")
    Radiobutton(rps_frame, text = "Paper", variable = player_choice, value = 2).grid(column = 1, row = 3, sticky = "nsew")
    Radiobutton(rps_frame, text = "Scissors", variable = player_choice, value = 3).grid(column = 1, row = 4, sticky = "nsew")

    Label(rps_frame, text = "Computer").grid(column = 3, row = 1, sticky = "nsew")
    Label(rps_frame, textvariable = computer_choice).grid(column = 3, row = 3, sticky = "nsew")


    Label(rps_frame, text = "Score").grid(column = 1, row = 5, sticky = "nsew")
    Label(rps_frame, textvariable = player_score).grid(column = 1, row = 6, sticky = "nsew")

    Label(rps_frame, text = "Score").grid(column = 3, row = 5, sticky = "nsew")
    Label(rps_frame, textvariable = computer_score).grid(column = 3, row = 6, sticky = "nsew")

    Button(rps_frame, text = "Play", command = start).grid(column = 2, row = 2, stick = "nsew")
    Label(rps_frame, textvariable = result_set, width = 50).grid(column = 2, row = 7, sticky = "nsew")
